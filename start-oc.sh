...
#find /sys | egrep -v volt|grep od|grep clk|grep 03:00.0
...
#find /sys | egrep -v volt|grep od|grep clk|grep 0d:00.0
#find /sys | egrep -v volt|grep od|grep clk|grep 0f:00.0
