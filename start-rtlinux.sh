...
echo 3800000  >> /sys/devices/system/cpu/cpufreq/policy0/scaling_max_freq
echo 3800000  >> /sys/devices/system/cpu/cpufreq/policy0/scaling_min_freq
echo 3800000  >> /sys/devices/system/cpu/cpufreq/policy1/scaling_max_freq
echo 3800000  >> /sys/devices/system/cpu/cpufreq/policy1/scaling_min_freq
...
echo 0,1 > /proc/irq/126/smp_affinity_list
...
echo 0,1 > /proc/irq/131/smp_affinity_list

#amdgpu(s)
echo 2,3 > /proc/irq/132/smp_affinity_list
echo 2,3 > /proc/irq/133/smp_affinity_list
